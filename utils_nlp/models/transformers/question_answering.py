...
class QAProcessor:
    """
    Class for preprocessing raw question answering data to generate train/test features.

    Args:
        model_name (str): Name of the model. Call QAProcessor.list_supported_models() to
        ...
        custom_tokenize (function, optional): A custom tokenize function used to tokenize the
            ...
            Defaults to None.
        cache_dir (str, otpional): Directory to cache the tokenizer. Defaults to ".".
    """

    def __init__(self, model_name, to_lower=False, custom_tokenize=None, cache_dir="."):
