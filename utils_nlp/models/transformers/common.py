...
class Tokenizer:
    def __init__(self, model_type, sub_model_type, to_lower=False, cache_dir="."):
        ...
        tokenizer_class = TOKENIZER_CLASSES[self.model_type.value]
        self.tokenizer = tokenizer_class.from_pretrained(
            self.sub_model_type.value, do_lower_case=to_lower, cache_dir=cache_dir
        )
