...
def clean_sts(filenames, src_dir, target_dir):
    ...
    for i, fp in enumerate(filepaths):
        ...
        print("Writing clean dataframe to {}".format(
...
class STSBenchmark():
    ...
    def __init__(self, which_split, base_data_path="./data"):
        ...
        self.filepath = os.path.join(
            self.base_data_path, "clean", "stsbenchmark", "sts-{}.csv".format(which_split))
    ...
    def _maybe_download_and_extract(self):
        ...
        if not os.path.exists(self.filepath):
            ...
            clean_sts(sts_files, sts_path, os.path.join(
                self.base_data_path, "clean", "stsbenchmark"))
