...
parser.add_argument("--summary_file", type=str, default="generated_summaries.txt", 
...
def main_worker(local_rank, ngpus_per_node, summarizer, args):
    ...
    if rank in [-1, 0]:
        ...
        _write_list_to_file(prediction, os.path.join(args.output_dir, args.summary_file))
