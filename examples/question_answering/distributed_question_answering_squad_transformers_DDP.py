...
parser.add_argument("--horovod_dist", type=bool, default=True)
...
def main_worker(local_rank, ngpus_per_node, qa_extractor, args):
    ...
    print(local_rank)
    print(world_size)
    # print(args.node_count * torch.cuda.device_count())
    ...
    #     os.mkdir(feature_cache_dir, exist_ok=True)
