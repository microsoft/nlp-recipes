...
Note that for certain kind of NLP problems, you may not need to build your own models. The following Microsoft services offer simple solutions to address common NLP tasks: 
...
<br><br><b>[Language Understanding](https://azure.microsoft.com/en-us/services/cognitive-services/language-understanding-intelligent-service/)</b> is a SaaS service to train and deploy a model as a REST API given a user-provided training set. You could do Intent Classification as well as Named Entity Extraction by performing simple steps of providing example utterences and labelling them. It supports Active Learning using Reinforcement Learning, so your model always keeps learning and improving.
