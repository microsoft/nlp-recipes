...
from utils_nlp.models.bert.sequence_encoding import (
    BERTSentenceEncoder, PoolingStrategy
)
...
@pytest.fixture()
def data():
    return ["how old are you?", "what's your age?", "my phone is good", "your cellphone looks great."]
